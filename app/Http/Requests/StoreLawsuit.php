...
class StoreLawsuit extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'number' => 'bail|required|numeric|unique:lawsuits,number,' . $this->lawsuit->id,
            ...
            'plaintiff_representatives.*' => 'bail|nullable|string|distinct|between:1,100',
            ...
            'defendant_representatives.*' => 'bail|nullable|string|distinct|between:1,100',

            'other_parties' => 'bail|array|between:1,30',
            'other_parties.*' => 'bail|nullable|string|distinct|between:1,100',
        ];
    }
}
