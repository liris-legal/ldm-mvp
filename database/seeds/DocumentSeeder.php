...
class DocumentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $rows = [
            ...
            [ '00002', 1, 1, 1, '訴状', '9415595560b7536-訴状サンプル.pdf', $time],
            [ '00002', 1, 2, 1, '証拠説明書', '2a47ed33f9c9d8c-証拠説明書サンプル.pdf', $time],
            [ '00002', 6, 3, 1, '期日経過報告書', '61d33bdd4f6df79-期日経過報告書サンプル.pdf', $time],
            [ '00002', 1, 1, 1, '答弁書', 'fdeece3b32c1c72-答弁書サンプル.pdf', $time],
            [ '00002', 1, 2, 1, '甲号証', '2020011706013331-証拠説明書サンプル.pdf', $time],
        ];
        foreach ($rows as $row) {
