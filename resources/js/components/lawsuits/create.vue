			...
			<v-container class="form-group-content">
              ...
              <small class="has-error" v-if="errors">{{ catchError(errors, 'courts_departments') }}</small>
					...
					<v-col cols="12" class="row form-control pa-2" v-for="(plaintiff, i) in lawsuit.plaintiffs" :key="plaintiff.i">
						<v-col class="col-3 pa-0 label"><label :for="'plaintiff-lawsuit' + i" class="font-weight-600">原告{{ countParties(lawsuit.plaintiffs, ++i) }}</label></v-col>
						<v-col class="col-9 pa-0 input">
							...
							<v-btn v-show="countParties(lawsuit.plaintiffs) > 1" v-on:click="removeItemFromParties(lawsuit, 'plaintiffs', --i)" icon class="icon-clear"><v-icon>remove_circle_outline</v-icon></v-btn>
              <small class="has-error" v-if="errors">{{ catchError(errors, 'plaintiffs', --i) }}</small>
						</v-col>
					</v-col>
					...
					<v-col cols="12" class="row form-control pa-2" v-for="(plaintiff_representative, i) in lawsuit.plaintiff_representatives" :key="plaintiff_representative.i">
						<v-col class="col-3 pa-0 label"><label :for="'plaintiff-representative-lawsuit' + i" class="font-weight-600">原告代理人{{ countParties(lawsuit.plaintiff_representatives, ++i) }}</label></v-col>
						<v-col class="col-9 pa-0 input">
							...
							<v-btn v-show="countParties(lawsuit.plaintiff_representatives) > 1" v-on:click="removeItemFromParties(lawsuit, 'plaintiff_representatives', --i)" icon class="icon-clear"><v-icon>remove_circle_outline</v-icon></v-btn>
              <small class="has-error" v-if="errors">{{ catchError(errors, 'plaintiff_representatives', --i) }}</small>
						</v-col>
					</v-col>

					<v-col cols="12" class="row form-control pa-2" v-for="(defendant, i) in lawsuit.defendants" :key="defendant.i">
						<v-col class="col-3 pa-0 label"><label :for="'defendant-lawsuit' + i" class="font-weight-600">被告{{ countParties(lawsuit.defendants, ++i) }}</label></v-col>
						<v-col class="col-9 pa-0 input">
							...
							<v-btn v-show="countParties(lawsuit.defendants) > 1" v-on:click="removeItemFromParties(lawsuit, 'defendants', --i)" icon class="icon-clear"><v-icon>remove_circle_outline</v-icon></v-btn>
              <small class="has-error" v-if="errors">{{ catchError(errors, 'defendants', --i) }}</small>
						</v-col>
					</v-col>
					...
					<v-col cols="12" class="row form-control pa-2" v-for="(defendant_representative, i, rorr) in lawsuit.defendant_representatives" :key="defendant_representative.i">
						<v-col class="col-3 pa-0 label"><label :for="'defendant-representative-lawsuit' + i" class="font-weight-600">被告代理人{{ countParties(lawsuit.defendant_representatives, ++i) }}</label></v-col>
						<v-col class="col-9 pa-0 input">
							...
							<v-btn v-show="countParties(lawsuit.defendant_representatives) > 1" v-on:click="removeItemFromParties(lawsuit, 'defendant_representatives', --i)" icon class="icon-clear"><v-icon>remove_circle_outline</v-icon></v-btn>
              <small class="has-error" v-if="errors">{{ catchError(errors, 'defendant_representatives', --i) }}</small>
						</v-col>
					</v-col>

					<v-col cols="12" class="row form-control pa-2" v-for="(other_party, i) in lawsuit.other_parties" :key="other_party.i">
						<v-col class="col-3 pa-0 label"><label :for="'other-party-lawsuit' + i" class="font-weight-600">その他当事者{{ countParties(lawsuit.other_parties, ++i) }}</label></v-col>
						<v-col class="col-9 pa-0 input">
							...
							<v-btn v-show="countParties(lawsuit.other_parties) > 1" v-on:click="removeItemFromParties(lawsuit, 'other_parties', --i)" icon class="icon-clear"><v-icon>remove_circle_outline</v-icon></v-btn>
              <small class="has-error" v-if="errors">{{ catchError(errors, 'other_parties', --i) }}</small>
            </v-col>
					</v-col>
				</v-row>
				<v-row>
