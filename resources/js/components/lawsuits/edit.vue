			...
			<v-container class="form-group-content">
				<v-row class="ma-0">
					...
					<v-col cols="12" class="row form-control">
						...
						<v-col class="col-9 pa-0 input"><input v-model.trim="lawsuit.number" id="number-lawsuit" type="text" class="input-form-group col-md-12"></v-col>
					</v-col>
					<v-col cols="12" class="row form-control">
						<v-col class="col-3 pa-0 label"><label for="name-lawsuit" class="font-weight-600">事件名</label></v-col>
						<v-col class="col-9 pa-0 input"><input v-model.trim="lawsuit.name" id="name-lawsuit" type="text" class="input-form-group col-md-12"></v-col>
					</v-col>
					<v-col cols="12" class="row form-control">
						<v-col class="col-3 pa-0 label"><label for="courts-lawsuit" class="font-weight-600">裁判所・部署</label></v-col>
						<v-col class="col-9 pa-0 input"><input v-model.trim="lawsuit.courts_departments" id="courts-lawsuit" type="text" class="input-form-group col-md-12"></v-col>
					</v-col>
